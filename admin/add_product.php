...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($_FILES['product_image']['error'] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($_FILES['product_image']['tmp_name'], $upload_path)) {
            $sql_insert_product = "INSERT INTO products (ProductName, Brand, Description, Price, StockQuantity, CategoryID, ImageURL, Timestamp) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
            $stmt_insert_product = mysqli_prepare($conn, $sql_insert_product);
            mysqli_stmt_bind_param($stmt_insert_product, "sssdiiss", $product_name, $brand, $description, $price, $stock_quantity, $category_id, $image_filename, $timestamp);
...
<body>
    ...
    <div class="container mt-5 mb-5">
        <div class="card mx-auto" style="max-width: 600px;">
            <div class="card-body">
                <h2 class="text-center">Add Products & Services</h2>
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <a class="btn btn-outline-dark" href="view_products.php">View Product</a>
                </form>
            </div>
        </div>
    </div>
