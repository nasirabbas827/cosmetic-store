...
if (isset($_GET['brand'])) {
    $brand = $_GET['brand'];
    if (!empty($brand)) {
        $where_conditions[] = "p.Brand LIKE '%$brand%'";
    }
}
...
<div class="jumbotron text-center">
    <h1>Welcome to Our Online Cosmetics Store</h1>
    <p>Discover top beauty brands, explore skincare essentials, and shop your favorite cosmetics all in one place</p>
    <a href="login.php" class="btn btn-primary btn-lg">Shop Now</a>
</div>
                            ...
                            <div class="col-md-4">
                                <div class="card" style="height: 100%;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title"><?php echo $row_new_arrival['Brand']; ?></h5>
...
<div class="container mt-5">
        <h2 class="mb-4">Available Products & Services</h2>

        <form method="GET" action="" class="mb-4">
    <div class="card p-3 shadow-sm">
        <div class="form-row">
            <div class="form-group col-md-3">
                <input type="text" class="form-control" placeholder="Search by Keyword" name="search" value="<?php echo $search_query; ?>">
            </div>
            <div class="form-group col-md-3">
                <input type="text" class="form-control" placeholder="Search by Product Name" name="product_name" value="<?php echo $product_name; ?>">
            </div>
            <div class="form-group col-md-3">
                <input type="text" class="form-control" placeholder="Search by Brand" name="brand" value="<?php echo $_GET['brand'] ?? ''; ?>">
            </div>
            <div class="form-group col-md-3">
                <select class="custom-select" name="category">
                    ...
                    <?php while ($row_category = mysqli_fetch_assoc($result_categories)) : ?>
                        <option value="<?php echo $row_category['id']; ?>" <?php if ($row_category['id'] == $category_id) echo "selected"; ?>>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Category: <?php echo $row['Brand']; ?></p>
  ...
  <div class="container">
    ...
    <div class="row mt-3">
      <div class="col">
        <p class="text-center mb-0">&copy; 2025 Online Cosmetic Store Project. All rights reserved.</p>
      </div>
    </div>
  </div>
</footer>
